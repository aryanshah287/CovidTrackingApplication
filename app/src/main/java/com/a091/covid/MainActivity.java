...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    com.a091.covid.Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApiUtilities.getAPIInterface().getcountrydata().enqueue(new Callback<List<ModelClass>>() {
            @Override
            public void onResponse(Call<List<com.a091.covid.ModelClass>> call, Response<List<ModelClass>> response) {
        ...
        countryCodePicker.setAutoDetectedCountry(true); //Auto Detects country in APK
